            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || mobile.isEmpty() || email.isEmpty() || pass.isEmpty() || cpass.isEmpty()) {
                    ...
                    if (isNew == null) {
                        ...
                        smsManager.sendTextMessage(mobile, null, "Welcome to All Abode " + name + "!\nHope we serve you well.", null, null);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (type.equals("Student")) {
                                    Intent intent = new Intent(RegisterActivity.this, SHomeActivity.class);
                                    startActivity(intent);
                                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                                    finish();
                                } else {
                                    Intent intent = new Intent(RegisterActivity.this, LHomeActivity.class);
                                    startActivity(intent);
                                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                                    finish();
                                }
